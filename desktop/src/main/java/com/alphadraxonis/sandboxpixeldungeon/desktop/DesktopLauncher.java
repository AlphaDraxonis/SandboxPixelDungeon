...
package com.alphadraxonis.sandboxpixeldungeon.desktop;
...
import com.alphadraxonis.sandboxpixeldungeon.services.news.NewsImpl;
import com.alphadraxonis.sandboxpixeldungeon.services.updates.UpdateImpl;
...
public class DesktopLauncher {
	...
	public static void main (String[] args) {
				...
				if (exceptionMsg.contains("Couldnt create window")){
					TinyFileDialogs.tinyfd_messageBox(title + " Has Crashed!",
							title + " was not able to initialize its graphics display, sorry about that!\n\n" +
									...
									"If you are certain the game should be working on your computer, feel free to message the developer (AlphaDraxonis@gmail.com)\n\n" +
		...
		new Lwjgl3Application(new SandboxPixelDungeon(new DesktopPlatformSupport()), config);
	}
}