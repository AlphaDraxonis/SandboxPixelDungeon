...
public class CharSprite extends MovieClip implements Tweener.Listener, MovieClip.Listener {
	...
	public enum State {
		BURNING, LEVITATING, INVISIBLE, HALF_INVISIBLE, PARALYSED, FROZEN, ILLUMINATED, CHILLED, DARKENED, MARKED, HEALING, SHIELDED, HEARTS, GLOWING
	}
	...
	public void showStatusWithIcon( int color, String text, int icon, Object... args ) {
		showStatusWithIcon(false, color, text, icon, args );
	}

	public void showStatusWithIcon( boolean ignoreVisibility, int color, String text, int icon, Object... args ) {
