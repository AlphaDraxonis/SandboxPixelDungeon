...
public class OriginalWndTitledMessage extends Window {
	
	protected static final int WIDTH_MIN    = 120;
	protected static final int WIDTH_MAX    = 220;
	protected static final int GAP	= 2;
	
	public OriginalWndTitledMessage( Image icon, String title, String message ) {
		
		this( new IconTitle( icon, title ), message );
		
	}
	
	public OriginalWndTitledMessage( Component titlebar, String message ) {
