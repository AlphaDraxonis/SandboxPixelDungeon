...
public class TitleScene extends PixelScene {
    ...
    public void create() {
        ...
        StyledButton btnSupport = new SupportButton(GREY_TR, "Map editor");
        add(btnSupport);
...
//            }
        ...
        protected void onClick() {
            super.onClick();
            ShatteredPixelDungeon.platform.openURI("https://docs.google.com/document/d/1LEx8uZYdv04ndrITJeUttdphXp_hkJ5WDdysWNQTXyY");
