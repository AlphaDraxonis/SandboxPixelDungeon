...
import com.shatteredpixel.shatteredpixeldungeon.usercontent.ui.editcomps.CustomMobEditor;
...
public class CustomMob extends CustomGameObject<CustomMobClass> {
	...
	public void restoreIDs() {
		...
		CustomCharSprite spriteObj = UserContentManager.getUserContent(sprite_id, CustomCharSprite.class);
