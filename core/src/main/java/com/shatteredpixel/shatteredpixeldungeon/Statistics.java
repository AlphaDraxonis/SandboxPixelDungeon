...
public class Statistics {
	...
	public static void storeInBundle( Bundle bundle ) {
		...
		String[] explKeys = floorsExplored.keySet().toArray(new String[0]);
		bundle.put(FLR_EXPL_KEYS,explKeys );
		for (int i = 0; i < explKeys.length; i++) {
			bundle.put(FLR_EXPL + i, floorsExplored.get(explKeys[i]));
		}
	...
	public static void restoreFromBundle( Bundle bundle ) {
		...
		String[] floorsExploredKeys = bundle.getStringArray(FLR_EXPL_KEYS);
