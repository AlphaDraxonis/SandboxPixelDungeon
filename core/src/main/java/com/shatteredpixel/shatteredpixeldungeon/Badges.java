...
//several badges all tie into catalog completion
	...
	private static void displayBadge( Badge badge ) {
		...
		if (badge == null || (badge.type != BadgeType.JOURNAL && !Dungeon.customSeedText.isEmpty()) || Dungeon.isLevelTesting()) {
			return;
		}
	...
	public static void unlock( Badge badge ){
		if (!isUnlocked(badge) && (badge.type == BadgeType.JOURNAL || Dungeon.customSeedText.isEmpty()) && !Dungeon.isLevelTesting()){
			global.add( badge );
			saveNeeded = true;
		}
	}
