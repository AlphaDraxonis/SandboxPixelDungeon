	...
	public static class ChallengeArena extends Buff {
		...
		public void setup(int pos){
			...
			if (Dungeon.level instanceof SewerBossLevel || Dungeon.level instanceof PrisonBossLevel || Dungeon.level instanceof CityBossLevel){
				...
				ShadowCaster.castShadow(c.x, c.y, Dungeon.level.width(), visibleCells, Dungeon.level.losBlocking, 8, false);
				int count=0;
			...
			PathFinder.buildDistanceMapForEnvironmentals( pos, Dungeon.level.getPassableAndAvoidVar(null), dist, true );
