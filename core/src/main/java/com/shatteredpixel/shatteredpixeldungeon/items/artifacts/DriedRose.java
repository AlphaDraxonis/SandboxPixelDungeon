...
public class DriedRose extends Artifact {
    ...
    @Override
    public Item clone()  {
        DriedRose i = (DriedRose) super.clone();
        if (weapon != null) i.weapon = (MeleeWeapon) weapon.clone();
        if (armor != null) i.armor = (Armor) armor.clone();
        return i;
    }
    ...
    public static class GhostHero extends DirectableAlly {
        ...
        public void sayAppeared() {
            if (Dungeon.hero.buff(AscensionChallenge.class) != null) {
                ...
                int depth = Dungeon.level.levelScheme.getRegion()-1;

                //only some lines are said on the first floor of a depth
                int variant = Random.IntRange(1, 6);
        ...
        public void sayBoss() {
            int depth = Dungeon.level.levelScheme.getBoss() - 1;
