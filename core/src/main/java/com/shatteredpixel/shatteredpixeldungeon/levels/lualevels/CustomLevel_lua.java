...
public class CustomLevel_lua extends CustomLevel implements LuaLevel {
    ...
    public void setWaterTexture(int arg0) {
        ...
        if (luaScript != null && !luaScript.get("setWaterTexture").isnil()) {
            try {
                MethodOverride.VoidA1 superMethod = (a0) -> super.setWaterTexture((int) a0);
               luaScript.get("setWaterTexture").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), LuaValue.valueOf(arg0)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public int getWaterTextureValue() {
        ...
        if (luaScript != null && !luaScript.get("getWaterTextureValue").isnil()) {
            try {
                MethodOverride.A0<Integer> superMethod = () -> super.getWaterTextureValue();
               int ret = luaScript.get("getWaterTextureValue").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod)).toint();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public int getRegionValue() {
        ...
        if (luaScript != null && !luaScript.get("getRegionValue").isnil()) {
            try {
                MethodOverride.A0<Integer> superMethod = () -> super.getRegionValue();
               int ret = luaScript.get("getRegionValue").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod)).toint();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void setRegion(int arg0) {
        ...
        if (luaScript != null && !luaScript.get("setRegion").isnil()) {
            try {
                MethodOverride.VoidA1 superMethod = (a0) -> super.setRegion((int) a0);
               luaScript.get("setRegion").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), LuaValue.valueOf(arg0)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public ItemsWithChanceDistrComp.RandomItemData getMobRotationVar() {
        LuaValue luaScript = levelScheme.luaScript.getScript();
        if (luaScript != null && !luaScript.get("getMobRotationVar").isnil()) {
            try {
                MethodOverride.A0<ItemsWithChanceDistrComp.RandomItemData> superMethod = () -> super.getMobRotationVar();
               ItemsWithChanceDistrComp.RandomItemData ret = (ItemsWithChanceDistrComp.RandomItemData) luaScript.get("getMobRotationVar").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod)).touserdata();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        return super.getMobRotationVar();
    }
    ...
    public List getItems() {
        LuaValue luaScript = levelScheme.luaScript.getScript();
        if (luaScript != null && !luaScript.get("getItems").isnil()) {
            try {
                MethodOverride.A0<List> superMethod = () -> super.getItems();
               List ret = (List) luaScript.get("getItems").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod)).touserdata();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public int randomRespawnCell(Char arg0, boolean arg1) {
        ...
        if (luaScript != null && !luaScript.get("randomRespawnCell").isnil()) {
            try {
                MethodOverride.A2<Integer> superMethod = (a0, a1) -> super.randomRespawnCell((Char) a0, (boolean) a1);
               int ret = luaScript.get("randomRespawnCell").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), CoerceJavaToLua.coerce(arg0), LuaValue.valueOf(arg1)}).arg1().toint();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
