...
//                "QUANTITY", 9);
    ...
    private static Integer[] createTypeData() {
        return new Integer[] {
                ...
                CustomParticle.ENERGY_PARTICLE,
                CustomParticle.SPARK_PARTICLE,
                
                CustomParticle.FOLIAGE_PARTICLE,
                Speck.LIGHT,
                Speck.RED_LIGHT,
                Speck.DISCOVER,
                ...
                Speck.CHANGE,
                Speck.HEART,
                CustomParticle.RAINBOW_PARTICLE,
                Speck.NOTE,
                Speck.CALM,
                Speck.SCREAM,
                CustomParticle.CHALLENGE_PARTICLE,

                Speck.RATTLE,
                Speck.BONE,
                CustomParticle.WEB_PARTICLE,

                CustomParticle.FLAMES_PARTICLE,
                CustomParticle.ETERNAL_FLAMES_PARTICLE,
                CustomParticle.SACRIFICIAL_FIRE_PARTICLE,
                CustomParticle.WIND_PARTICLE,
                Speck.WOOL,
                Speck.ROCK,
                CustomParticle.LEAF_PARTICLE,
                Speck.BUBBLE,
                CustomParticle.WATER_SPLASH_PARTICLE,
                Speck.COIN,

                CustomParticle.POISON_PARTICLE,
                CustomParticle.CORROSION_PARTICLE,
                CustomParticle.BLAST_PARTICLE,
                CustomParticle.SNOW_PARTICLE,
                Speck.TOXIC,
                Speck.CORROSION,
                Speck.PARALYSIS,
                Speck.STENCH,
