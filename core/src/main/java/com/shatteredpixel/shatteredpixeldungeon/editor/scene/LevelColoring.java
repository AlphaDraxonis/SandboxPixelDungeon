                        ...
                        if (CustomDungeon.isEditing() || Dungeon.customDungeon.view2d) {
                            ...
                            if ((result & BOTTOM) == 0 && DungeonTileSheet.wallStitcheable(map[cell])) {
                                ...
                                if ((result & BOTTOM_RIGHT) == 0 || (result & BOTTOM_LEFT) == 0) {
                                    ...
                                    img.size(verticalWallWidth * TILE_SCALE, 12 * TILE_SCALE);
                                }
                                if ((result & LEFT) == LEFT && (result & BOTTOM_LEFT) == BOTTOM_LEFT) {
                                    ...
                                    img.size(verticalWallWidth * TILE_SCALE, (result & BOTTOM_LEFT) == 0 ? 16 * TILE_SCALE : 12 * TILE_SCALE);
                                    ColorBlock alt = altComps1.get(cell);
                                    if (alt == null) {
                                        alt = initNewColorblock(cell, false);
                                        altComps1.put(cell, alt);
                                    ...
                                    super.updateColor(alt, cell);
                                    alt.size(img.width(), (result & BOTTOM_RIGHT) == 0 ? 16 * TILE_SCALE : 12 * TILE_SCALE);
                                ...
                                if ((result & BOTTOM_RIGHT) == 0 || (result & BOTTOM_LEFT) == 0) {
                                    ...
                                    alt.origin.set((result & BOTTOM_LEFT) == 0 ? 0 : (16 - verticalWallWidth) * TILE_SCALE, 12 * TILE_SCALE);
                                    destroyAlt1 = false;
                                    ...
                                    if ((result & BOTTOM_RIGHT) == 0 && (result & BOTTOM_LEFT) == 0) {
                                        ...
                                        super.updateColor(alt, cell);
                                        alt.size(verticalWallWidth * TILE_SCALE, horizontalWallHeight * TILE_SCALE);
                                        alt.origin.set((16 - verticalWallWidth) * TILE_SCALE, 12 * TILE_SCALE);
                                        destroyAlt2 = false;
                                    }
                                ...
                                img.size(horizontalDoorWidth * TILE_SCALE, 12 * TILE_SCALE);
                                ColorBlock alt = altComps1.get(cell);
                                if (alt == null) {
                                    alt = initNewColorblock(cell, false);
                                    altComps1.put(cell, alt);
