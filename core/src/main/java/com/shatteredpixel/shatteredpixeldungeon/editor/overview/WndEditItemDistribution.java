...
public class WndEditItemDistribution<T extends Item> extends Window {
    ...
    public WndEditItemDistribution(ItemDistribution<T> itemDistribution) {
        ...
        container = new ItemContainer<T>(itemDistribution.getObjectsToDistribute()) {
            ...
            protected void onSlotNumChange() {
                if (objectsToDistribute != null) onChange();
            }
    ...
    private void updateLayout() {
        ...
        scrollPane.setRect(0, 0, width, height - GAP);
    }
