...
@Override
    ...
    public int addFist(YogFist arg0) {
        ...
        if (luaScript != null && !luaScript.get("addFist").isnil()) {
            try {
                int ret = luaScript.get("addFist").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(arg0)).toint();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public int super_addFist(YogFist arg0) {
        return super.addFist(arg0);
    }
    ...
    public void updateVisibility(Level arg0) {
        ...
        if (luaScript != null && !luaScript.get("updateVisibility").isnil()) {
            try {
                luaScript.get("updateVisibility").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(arg0));
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_updateVisibility(Level arg0) {
        super.updateVisibility(arg0);
    }
