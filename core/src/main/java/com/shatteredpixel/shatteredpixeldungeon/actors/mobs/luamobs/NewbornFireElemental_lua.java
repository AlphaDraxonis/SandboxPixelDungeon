...
@Override
    ...
    public void setSummonedALly() {
        ...
        if (luaScript != null && !luaScript.get("setSummonedALly").isnil()) {
            try {
                luaScript.get("setSummonedALly").call(CoerceJavaToLua.coerce(this), vars);
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_setSummonedALly() {
        super.setSummonedALly();
    }
    ...
    protected void rangedProc(Char arg0) {
        ...
        if (luaScript != null && !luaScript.get("rangedProc").isnil()) {
            try {
                luaScript.get("rangedProc").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(arg0));
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_rangedProc(Char arg0) {
        super.rangedProc(arg0);
    }
    ...
    protected void meleeProc(Char arg0, int arg1) {
        ...
        if (luaScript != null && !luaScript.get("meleeProc").isnil()) {
            try {
                luaScript.get("meleeProc").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(arg0), LuaValue.valueOf(arg1)}).arg1();
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_meleeProc(Char arg0, int arg1) {
        super.meleeProc(arg0, arg1);
    }
