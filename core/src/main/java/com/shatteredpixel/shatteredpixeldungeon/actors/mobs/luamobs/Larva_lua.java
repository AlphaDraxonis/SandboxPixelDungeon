...
@Override
    ...
    public void setId(int arg0) {
        ...
        if (luaScript != null && !luaScript.get("setId").isnil()) {
            try {
                luaScript.get("setId").call(CoerceJavaToLua.coerce(this), vars, LuaValue.valueOf(arg0));
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        super.setId(arg0);
    ...
    public void super_setId(int arg0) {
        super.setId(arg0);
    }
    ...
    public int getId() {
        ...
        if (luaScript != null && !luaScript.get("getId").isnil()) {
            try {
                int ret = luaScript.get("getId").call(CoerceJavaToLua.coerce(this), vars).toint();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        return super.getId();
