...
public class HeroMob_lua extends HeroMob implements LuaMob {
...
@Override
    ...
    protected void useMeleeAttackItem() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("useMeleeAttackItem").isnil()) {
            try {
                MethodOverride.VoidA0 superMethod = () -> super.useMeleeAttackItem();
               luaScript.get("useMeleeAttackItem").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod));
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.useMeleeAttackItem();
    }
    ...
    public void setLevel(int arg0) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("setLevel").isnil()) {
            try {
    ...
    @Override
    public boolean killedMob(Object arg0) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("killedMob").isnil()) {
            try {
                MethodOverride.A1<Boolean> superMethod = (a0) -> super.killedMob(a0);
               boolean ret = luaScript.get("killedMob").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), CoerceJavaToLua.coerce(arg0)}).arg1().toboolean();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        return super.killedMob(arg0);
    }
    ...
    protected void useDistanceAttackItem() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("useDistanceAttackItem").isnil()) {
            try {
                MethodOverride.VoidA0 superMethod = () -> super.useDistanceAttackItem();
               luaScript.get("useDistanceAttackItem").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod));
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.useDistanceAttackItem();
    }
    ...
    public boolean isStarving() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("isStarving").isnil()) {
            try {
                MethodOverride.A0<Boolean> superMethod = () -> super.isStarving();
               boolean ret = luaScript.get("isStarving").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod)).toboolean();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
    ...
    @Override
    public void setHeroLvl(int arg0) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("setHeroLvl").isnil()) {
            try {
                MethodOverride.VoidA1 superMethod = (a0) -> super.setHeroLvl((int) a0);
               luaScript.get("setHeroLvl").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), LuaValue.valueOf(arg0)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.setHeroLvl(arg0);
    }
    ...
    @Override
    public void setInternalHero(HeroMob.InternalHero arg0) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("setInternalHero").isnil()) {
            try {
                MethodOverride.VoidA1 superMethod = (a0) -> super.setInternalHero((HeroMob.InternalHero) a0);
               luaScript.get("setInternalHero").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), CoerceJavaToLua.coerce(arg0)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.setInternalHero(arg0);
    }
    ...
    @Override
    public void armor(Armor arg0) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("armor").isnil()) {
            try {
                MethodOverride.VoidA1 superMethod = (a0) -> super.armor((Armor) a0);
               luaScript.get("armor").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), CoerceJavaToLua.coerce(arg0)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.armor(arg0);
    }
    ...
    @Override
    public HeroMob.InternalHero hero() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("hero").isnil()) {
            try {
                MethodOverride.A0<HeroMob.InternalHero> superMethod = () -> super.hero();
               HeroMob.InternalHero ret = (HeroMob.InternalHero) luaScript.get("hero").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod)).touserdata();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        return super.hero();
    ...
    public void weapon(Weapon arg0) {
        ...
        if (luaScript != null && !luaScript.get("weapon").isnil()) {
            try {
                MethodOverride.VoidA1 superMethod = (a0) -> super.weapon((Weapon) a0);
               luaScript.get("weapon").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), CoerceJavaToLua.coerce(arg0)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.weapon(arg0);
    }
    ...
    public Window mobInfoWindow() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("mobInfoWindow").isnil()) {
            try {
                MethodOverride.A0<Window> superMethod = () -> super.mobInfoWindow();
               Window ret = (Window) luaScript.get("mobInfoWindow").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod)).touserdata();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        return super.mobInfoWindow();
    }
    ...
    @Override
    public void earnExp(int arg0, Class arg1) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("earnExp").isnil()) {
            try {
                MethodOverride.VoidA2 superMethod = (a0, a1) -> super.earnExp((int) a0, (Class) a1);
               luaScript.get("earnExp").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), LuaValue.valueOf(arg0), CoerceJavaToLua.coerce(arg1)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.earnExp(arg0, arg1);
    }
