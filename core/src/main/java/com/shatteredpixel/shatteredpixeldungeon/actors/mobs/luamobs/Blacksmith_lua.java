...
@Override
    ...
    public void place(RegularLevel arg0, List arg1) {
        ...
        if (luaScript != null && !luaScript.get("place").isnil()) {
            try {
                luaScript.get("place").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(arg0), CoerceJavaToLua.coerce(arg1)}).arg1();
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_place(RegularLevel arg0, List arg1) {
        super.place(arg0, arg1);
    }
    ...
    public void initQuest(LevelScheme arg0) {
        ...
        if (luaScript != null && !luaScript.get("initQuest").isnil()) {
            try {
                luaScript.get("initQuest").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(arg0));
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_initQuest(LevelScheme arg0) {
        super.initQuest(arg0);
    }
    ...
    public void createNewQuest() {
        ...
        if (luaScript != null && !luaScript.get("createNewQuest").isnil()) {
            try {
                luaScript.get("createNewQuest").call(CoerceJavaToLua.coerce(this), vars);
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_createNewQuest() {
        super.createNewQuest();
    }
    ...
    public void registerQuest() {
        ...
        if (luaScript != null && !luaScript.get("registerQuest").isnil()) {
            try {
                luaScript.get("registerQuest").call(CoerceJavaToLua.coerce(this), vars);
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        super.registerQuest();
    ...
    public void super_registerQuest() {
        super.registerQuest();
    }
