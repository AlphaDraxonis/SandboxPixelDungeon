...
public class Blacksmith_lua extends Blacksmith implements LuaMob {
...
@Override
    ...
    @Override
    public void place(RegularLevel arg0, List arg1) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("place").isnil()) {
            try {
                MethodOverride.VoidA2 superMethod = (a0, a1) -> super.place((RegularLevel) a0, (List) a1);
               luaScript.get("place").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), CoerceJavaToLua.coerce(arg0), CoerceJavaToLua.coerce(arg1)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        super.place(arg0, arg1);
    }
    ...
    @Override
    public void initQuest(LevelScheme arg0) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("initQuest").isnil()) {
            try {
                MethodOverride.VoidA1 superMethod = (a0) -> super.initQuest((LevelScheme) a0);
               luaScript.get("initQuest").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), CoerceJavaToLua.coerce(arg0)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        super.initQuest(arg0);
    }

    @Override
    public void createNewQuest() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("createNewQuest").isnil()) {
            try {
                MethodOverride.VoidA0 superMethod = () -> super.createNewQuest();
               luaScript.get("createNewQuest").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod));
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        super.createNewQuest();
    }
    ...
    public void registerQuest() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("registerQuest").isnil()) {
            try {
                MethodOverride.VoidA0 superMethod = () -> super.registerQuest();
               luaScript.get("registerQuest").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod));
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        super.registerQuest();
    }
