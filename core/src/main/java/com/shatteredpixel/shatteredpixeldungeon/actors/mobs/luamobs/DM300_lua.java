...
public class DM300_lua extends DM300 implements LuaMob {
...
@Override
    ...
    public void loseSupercharge() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("loseSupercharge").isnil()) {
            try {
                MethodOverride.VoidA0 superMethod = () -> super.loseSupercharge();
               luaScript.get("loseSupercharge").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod));
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.loseSupercharge();
    }
    ...
    @Override
    public void dropRocks(Char arg0) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("dropRocks").isnil()) {
            try {
                MethodOverride.VoidA1 superMethod = (a0) -> super.dropRocks((Char) a0);
               luaScript.get("dropRocks").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), CoerceJavaToLua.coerce(arg0)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.dropRocks(arg0);
    }
    ...
    @Override
    public void ventGas(Char arg0) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("ventGas").isnil()) {
            try {
                MethodOverride.VoidA1 superMethod = (a0) -> super.ventGas((Char) a0);
               luaScript.get("ventGas").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), CoerceJavaToLua.coerce(arg0)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.ventGas(arg0);
    }
    ...
    public void supercharge() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("supercharge").isnil()) {
            try {
                MethodOverride.VoidA0 superMethod = () -> super.supercharge();
               luaScript.get("supercharge").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod));
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.supercharge();
    }
    ...
    public int totalPylonsToActivate() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("totalPylonsToActivate").isnil()) {
            try {
                MethodOverride.A0<Integer> superMethod = () -> super.totalPylonsToActivate();
               int ret = luaScript.get("totalPylonsToActivate").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod)).toint();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        return super.totalPylonsToActivate();
    }
    ...
    public void onSlamComplete() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("onSlamComplete").isnil()) {
            try {
                MethodOverride.VoidA0 superMethod = () -> super.onSlamComplete();
               luaScript.get("onSlamComplete").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod));
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.onSlamComplete();
    }
    ...
    public boolean isSupercharged() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("isSupercharged").isnil()) {
            try {
                MethodOverride.A0<Boolean> superMethod = () -> super.isSupercharged();
               boolean ret = luaScript.get("isSupercharged").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod)).toboolean();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        return super.isSupercharged();
    }
