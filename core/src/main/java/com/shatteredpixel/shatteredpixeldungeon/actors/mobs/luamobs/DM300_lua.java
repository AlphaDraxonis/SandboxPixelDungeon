...
@Override
    ...
    public void loseSupercharge() {
        ...
        if (luaScript != null && !luaScript.get("loseSupercharge").isnil()) {
            try {
                luaScript.get("loseSupercharge").call(CoerceJavaToLua.coerce(this), vars);
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_loseSupercharge() {
        super.loseSupercharge();
    }
    ...
    public void dropRocks(Char arg0) {
        ...
        if (luaScript != null && !luaScript.get("dropRocks").isnil()) {
            try {
                luaScript.get("dropRocks").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(arg0));
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_dropRocks(Char arg0) {
        super.dropRocks(arg0);
    }
    ...
    public void ventGas(Char arg0) {
        ...
        if (luaScript != null && !luaScript.get("ventGas").isnil()) {
            try {
                luaScript.get("ventGas").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(arg0));
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        super.ventGas(arg0);
    ...
    public void super_ventGas(Char arg0) {
        super.ventGas(arg0);
    }
    ...
    public void supercharge() {
        ...
        if (luaScript != null && !luaScript.get("supercharge").isnil()) {
            try {
                luaScript.get("supercharge").call(CoerceJavaToLua.coerce(this), vars);
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        super.supercharge();
    ...
    public int totalPylonsToActivate() {
        ...
        if (luaScript != null && !luaScript.get("totalPylonsToActivate").isnil()) {
            try {
                int ret = luaScript.get("totalPylonsToActivate").call(CoerceJavaToLua.coerce(this), vars).toint();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public int super_totalPylonsToActivate() {
        return super.totalPylonsToActivate();
    }
    ...
    public void onSlamComplete() {
        ...
        if (luaScript != null && !luaScript.get("onSlamComplete").isnil()) {
            try {
                luaScript.get("onSlamComplete").call(CoerceJavaToLua.coerce(this), vars);
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_onSlamComplete() {
        super.onSlamComplete();
    }
    ...
    public boolean isSupercharged() {
        ...
        if (luaScript != null && !luaScript.get("isSupercharged").isnil()) {
            try {
                boolean ret = luaScript.get("isSupercharged").call(CoerceJavaToLua.coerce(this), vars).toboolean();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public boolean super_isSupercharged() {
        return super.isSupercharged();
    }
