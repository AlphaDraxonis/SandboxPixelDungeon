...
@Override
    ...
    public void createItems(boolean arg0) {
        ...
        if (luaScript != null && !luaScript.get("createItems").isnil()) {
            try {
                luaScript.get("createItems").call(CoerceJavaToLua.coerce(this), vars, LuaValue.valueOf(arg0));
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_createItems(boolean arg0) {
        super.createItems(arg0);
    }
    ...
    public ItemSelector.NullTypeSelector useNullWeapon() {
        ...
        if (luaScript != null && !luaScript.get("useNullWeapon").isnil()) {
            try {
                ItemSelector.NullTypeSelector ret = (ItemSelector.NullTypeSelector) luaScript.get("useNullWeapon").call(CoerceJavaToLua.coerce(this), vars).touserdata();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public ItemSelector.NullTypeSelector super_useNullWeapon() {
        return super.useNullWeapon();
    }
    ...
    public ItemSelector.NullTypeSelector useNullArmor() {
        ...
        if (luaScript != null && !luaScript.get("useNullArmor").isnil()) {
            try {
                ItemSelector.NullTypeSelector ret = (ItemSelector.NullTypeSelector) luaScript.get("useNullArmor").call(CoerceJavaToLua.coerce(this), vars).touserdata();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public ItemSelector.NullTypeSelector super_useNullArmor() {
        return super.useNullArmor();
    }
