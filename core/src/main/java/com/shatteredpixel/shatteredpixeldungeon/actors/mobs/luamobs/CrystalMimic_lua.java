...
@Override
    ...
    public void stopHiding() {
        ...
        if (luaScript != null && !luaScript.get("stopHiding").isnil()) {
            try {
                luaScript.get("stopHiding").call(CoerceJavaToLua.coerce(this), vars);
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        super.stopHiding();
    ...
    public boolean isLikeChest() {
        ...
        if (luaScript != null && !luaScript.get("isLikeChest").isnil()) {
            try {
                boolean ret = luaScript.get("isLikeChest").call(CoerceJavaToLua.coerce(this), vars).toboolean();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public boolean super_isLikeChest() {
        return super.isLikeChest();
    }
    ...
    protected void generatePrize(boolean arg0) {
        ...
        if (luaScript != null && !luaScript.get("generatePrize").isnil()) {
            try {
                luaScript.get("generatePrize").call(CoerceJavaToLua.coerce(this), vars, LuaValue.valueOf(arg0));
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_generatePrize(boolean arg0) {
        super.generatePrize(arg0);
    }
    ...
    protected void steal(Hero arg0) {
        ...
        if (luaScript != null && !luaScript.get("steal").isnil()) {
            try {
                luaScript.get("steal").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(arg0));
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        super.steal(arg0);
    ...
    public void super_steal(Hero arg0) {
        super.steal(arg0);
    }
    ...
    public void adjustStats(int arg0) {
        ...
        if (luaScript != null && !luaScript.get("adjustStats").isnil()) {
            try {
                luaScript.get("adjustStats").call(CoerceJavaToLua.coerce(this), vars, LuaValue.valueOf(arg0));
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_adjustStats(int arg0) {
        super.adjustStats(arg0);
    }
