...
public class CrystalMimic_lua extends CrystalMimic implements LuaMob {
...
@Override
    ...
    public void stopHiding() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("stopHiding").isnil()) {
            try {
                MethodOverride.VoidA0 superMethod = () -> super.stopHiding();
               luaScript.get("stopHiding").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod));
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.stopHiding();
    }
    ...
    public boolean isLikeChest() {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("isLikeChest").isnil()) {
            try {
                MethodOverride.A0<Boolean> superMethod = () -> super.isLikeChest();
               boolean ret = luaScript.get("isLikeChest").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod)).toboolean();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        return super.isLikeChest();
    }
    ...
    @Override
    protected void generatePrize(boolean arg0) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("generatePrize").isnil()) {
            try {
                MethodOverride.VoidA1 superMethod = (a0) -> super.generatePrize((boolean) a0);
               luaScript.get("generatePrize").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), LuaValue.valueOf(arg0)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.generatePrize(arg0);
    }
    ...
    @Override
    protected void steal(Hero arg0) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("steal").isnil()) {
            try {
                MethodOverride.VoidA1 superMethod = (a0) -> super.steal((Hero) a0);
               luaScript.get("steal").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), CoerceJavaToLua.coerce(arg0)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.steal(arg0);
    }
    ...
    @Override
    public void adjustStats(int arg0) {
        LuaValue luaScript = CustomObject.getScript(identifier);
        if (luaScript != null && !luaScript.get("adjustStats").isnil()) {
            try {
                MethodOverride.VoidA1 superMethod = (a0) -> super.adjustStats((int) a0);
               luaScript.get("adjustStats").invoke(new LuaValue[]{CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(superMethod), LuaValue.valueOf(arg0)}).arg1();
            } catch (LuaError error) { Game.runOnRenderThread(()->	DungeonScene.show(new WndError(error))); }
        }
        super.adjustStats(arg0);
    }
