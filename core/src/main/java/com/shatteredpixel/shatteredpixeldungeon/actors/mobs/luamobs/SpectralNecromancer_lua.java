...
@Override
    ...
    protected Mob convertToSummonedMob(Mob arg0) {
        ...
        if (luaScript != null && !luaScript.get("convertToSummonedMob").isnil()) {
            try {
                Mob ret = (Mob) luaScript.get("convertToSummonedMob").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(arg0)).touserdata();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public Mob super_convertToSummonedMob(Mob arg0) {
        return super.convertToSummonedMob(arg0);
    }
    ...
    public Mob summonMinion() {
        ...
        if (luaScript != null && !luaScript.get("summonMinion").isnil()) {
            try {
                Mob ret = (Mob) luaScript.get("summonMinion").call(CoerceJavaToLua.coerce(this), vars).touserdata();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    protected Mob createSummonedMob() {
        ...
        if (luaScript != null && !luaScript.get("createSummonedMob").isnil()) {
            try {
                Mob ret = (Mob) luaScript.get("createSummonedMob").call(CoerceJavaToLua.coerce(this), vars).touserdata();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public Mob super_createSummonedMob() {
        return super.createSummonedMob();
    }
