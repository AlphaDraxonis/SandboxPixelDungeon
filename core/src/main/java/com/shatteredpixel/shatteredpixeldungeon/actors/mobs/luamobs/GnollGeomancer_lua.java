...
@Override
    ...
    public boolean hasSapper() {
        ...
        if (luaScript != null && !luaScript.get("hasSapper").isnil()) {
            try {
                boolean ret = luaScript.get("hasSapper").call(CoerceJavaToLua.coerce(this), vars).toboolean();
                return ret;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public boolean super_hasSapper() {
        return super.hasSapper();
    }
    ...
    public void linkSapper(GnollSapper arg0) {
        ...
        if (luaScript != null && !luaScript.get("linkSapper").isnil()) {
            try {
                luaScript.get("linkSapper").call(CoerceJavaToLua.coerce(this), vars, CoerceJavaToLua.coerce(arg0));
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
    ...
    public void super_linkSapper(GnollSapper arg0) {
        super.linkSapper(arg0);
    }
    ...
    public void loseSapper() {
        ...
        if (luaScript != null && !luaScript.get("loseSapper").isnil()) {
            try {
                luaScript.get("loseSapper").call(CoerceJavaToLua.coerce(this), vars);
                return;
            } catch (LuaError error) { Game.runOnRenderThread(() -> DungeonScene.show(new WndError(error))); }
        }
        super.loseSapper();
