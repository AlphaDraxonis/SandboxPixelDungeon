...
public class DungeonTileSheet {
	...
	public static HashSet<Integer> waterStitcheable = new HashSet<>(Arrays.asList(
			...
			Terrain.ALCHEMY, Terrain.MINE_CRYSTAL, Terrain.MINE_BOULDER,
	...
	public static final int DOOR_OVERHANG_SECRET        = DOOR_OVERHANG+2;
	...
	public static final int DOOR_SIDEWAYS_SECRET        = DOOR_OVERHANG+5;
