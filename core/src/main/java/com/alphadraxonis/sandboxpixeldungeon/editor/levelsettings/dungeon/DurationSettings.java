...
import com.alphadraxonis.sandboxpixeldungeon.actors.buffs.ToxicImbue;
...
import com.alphadraxonis.sandboxpixeldungeon.items.potions.exotic.PotionOfCleansing.Cleanse;
...
//        return Messages.NO_TEXT_FOUND;
    ...
    private static abstract class SettingsTab extends Component {
        ...
        protected void layout() {
            ...
            info.setPos(x, y + 1);
            if (elements != null) {
                EditorUtilies.layoutStyledCompsInRectangles(2, width, wrapper, elements);
                wrapper.setPos(x, info.bottom() + 4);
