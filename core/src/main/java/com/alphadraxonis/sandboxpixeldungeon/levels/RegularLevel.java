...
import com.alphadraxonis.sandboxpixeldungeon.items.journal.GuidePage;
import com.alphadraxonis.sandboxpixeldungeon.items.journal.RegionLorePage;
...
import com.alphadraxonis.sandboxpixeldungeon.levels.builders.LoopBuilder;
...
public abstract class RegularLevel extends Level {
	...
	protected void createMobs() {
		...
		if (levelScheme.spawnMobs) {
			...
			int mobsToSpawn = (CustomDungeon.isEditing() ? Dungeon.getSimulatedDepth() : Dungeon.depth) <= 1 ? 8 : mobLimit();
