...
import com.alphadraxonis.sandboxpixeldungeon.ui.BadgesGrid;
import com.alphadraxonis.sandboxpixeldungeon.ui.BadgesList;
...
import com.alphadraxonis.sandboxpixeldungeon.ui.TalentButton;
import com.alphadraxonis.sandboxpixeldungeon.ui.TalentsPane;
	...
	private class StatsTab extends Group {
		...
		public StatsTab() {
			...
			if (Dungeon.hero == null){
				...
				IconButton scoreInfo = new IconButton(Icons.get(Icons.INFO)) {
					...
					protected void onClick() {
						super.onClick();
						SandboxPixelDungeon.scene().addToFront(new WndScoreBreakdown());
					}
				};
			...
			if (Dungeon.hero != null && Dungeon.seed != -1 && !Dungeon.daily &&
					(DeviceCompat.isDebug() || Badges.isUnlocked(Badges.Badge.VICTORY) || true)){
