...
import com.alphadraxonis.sandboxpixeldungeon.windows.WndDailies;
import com.alphadraxonis.sandboxpixeldungeon.windows.WndRanking;
		...
		if (Rankings.INSTANCE.latestDaily != null) {
			IconButton btnDailies = new IconButton(Icons.CALENDAR.get()) {
				...
				protected void onClick() {
					SandboxPixelDungeon.scene().addToFront(new WndDailies());
				}
