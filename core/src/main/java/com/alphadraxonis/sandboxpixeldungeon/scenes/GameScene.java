...
import com.alphadraxonis.sandboxpixeldungeon.tiles.FogOfWar;
...
import com.alphadraxonis.sandboxpixeldungeon.tiles.WallBlockingTilemap;
...
import com.alphadraxonis.sandboxpixeldungeon.ui.Banner;
import com.alphadraxonis.sandboxpixeldungeon.ui.BossHealthBar;
import com.alphadraxonis.sandboxpixeldungeon.ui.CharHealthIndicator;
import com.alphadraxonis.sandboxpixeldungeon.ui.GameLog;
import com.alphadraxonis.sandboxpixeldungeon.ui.Icons;
import com.alphadraxonis.sandboxpixeldungeon.ui.InventoryPane;
import com.alphadraxonis.sandboxpixeldungeon.ui.LootIndicator;
import com.alphadraxonis.sandboxpixeldungeon.ui.MenuPane;
import com.alphadraxonis.sandboxpixeldungeon.ui.QuickSlotButton;
import com.alphadraxonis.sandboxpixeldungeon.ui.ResumeIndicator;
import com.alphadraxonis.sandboxpixeldungeon.ui.RightClickMenu;
import com.alphadraxonis.sandboxpixeldungeon.ui.StatusPane;
import com.alphadraxonis.sandboxpixeldungeon.ui.StyledButton;
import com.alphadraxonis.sandboxpixeldungeon.ui.Tag;
import com.alphadraxonis.sandboxpixeldungeon.ui.TargetHealthIndicator;
...
import com.alphadraxonis.sandboxpixeldungeon.windows.WndInfoItem;
import com.alphadraxonis.sandboxpixeldungeon.windows.WndInfoMob;
import com.alphadraxonis.sandboxpixeldungeon.windows.WndInfoPlant;
import com.alphadraxonis.sandboxpixeldungeon.windows.WndInfoTrap;
...
import com.alphadraxonis.sandboxpixeldungeon.windows.WndStory;
...
public class GameScene extends PixelScene {
	...
	public static void sortMobSprites(){
		if (CustomDungeon.isEditing()) EditorScene.sortMobSprites();
		if (scene != null){
			synchronized (scene) {
	...
	public static void add( Heap heap ) {
		if (CustomDungeon.isEditing()) EditorScene.add(heap);
		else if (scene != null) {
	...
	public static void discard( Heap heap ) {
		if (CustomDungeon.isEditing()) EditorScene.discard(heap);
		else if (scene != null) {
