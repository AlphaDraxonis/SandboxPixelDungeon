...
package com.alphadraxonis.sandboxpixeldungeon.items.rings;
...
public class RingOfForce extends Ring {
	...
	public String statsInfo() {
		...
		if (isIdentified()) {
			...
			if (Dungeon.hero != null && isEquipped(Dungeon.hero) && soloBuffedBonus() != combinedBuffedBonus(Dungeon.hero, Force.class)){
