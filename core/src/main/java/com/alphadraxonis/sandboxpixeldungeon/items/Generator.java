...
import com.alphadraxonis.sandboxpixeldungeon.items.armor.HuntressArmor;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.LeatherArmor;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.MageArmor;
...
import com.alphadraxonis.sandboxpixeldungeon.items.armor.RogueArmor;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.ScaleArmor;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.WarriorArmor;
import com.alphadraxonis.sandboxpixeldungeon.items.artifacts.AlchemistsToolkit;
import com.alphadraxonis.sandboxpixeldungeon.items.artifacts.Artifact;
import com.alphadraxonis.sandboxpixeldungeon.items.artifacts.ChaliceOfBlood;
...
import com.alphadraxonis.sandboxpixeldungeon.items.artifacts.EtherealChains;
import com.alphadraxonis.sandboxpixeldungeon.items.artifacts.HornOfPlenty;
import com.alphadraxonis.sandboxpixeldungeon.items.artifacts.MasterThievesArmband;
import com.alphadraxonis.sandboxpixeldungeon.items.artifacts.SandalsOfNature;
...
import com.alphadraxonis.sandboxpixeldungeon.items.artifacts.UnstableSpellbook;
...
import com.alphadraxonis.sandboxpixeldungeon.items.rings.RingOfElements;
import com.alphadraxonis.sandboxpixeldungeon.items.rings.RingOfEnergy;
...
import com.alphadraxonis.sandboxpixeldungeon.items.rings.RingOfFuror;
import com.alphadraxonis.sandboxpixeldungeon.items.rings.RingOfHaste;
import com.alphadraxonis.sandboxpixeldungeon.items.rings.RingOfMight;
import com.alphadraxonis.sandboxpixeldungeon.items.rings.RingOfSharpshooting;
import com.alphadraxonis.sandboxpixeldungeon.items.rings.RingOfTenacity;
...
import com.alphadraxonis.sandboxpixeldungeon.items.stones.StoneOfBlast;
import com.alphadraxonis.sandboxpixeldungeon.items.stones.StoneOfBlink;
import com.alphadraxonis.sandboxpixeldungeon.items.stones.StoneOfClairvoyance;
import com.alphadraxonis.sandboxpixeldungeon.items.stones.StoneOfDeepSleep;
import com.alphadraxonis.sandboxpixeldungeon.items.stones.StoneOfDisarming;
import com.alphadraxonis.sandboxpixeldungeon.items.stones.StoneOfEnchantment;
import com.alphadraxonis.sandboxpixeldungeon.items.stones.StoneOfFear;
import com.alphadraxonis.sandboxpixeldungeon.items.stones.StoneOfFlock;
import com.alphadraxonis.sandboxpixeldungeon.items.stones.StoneOfIntuition;
import com.alphadraxonis.sandboxpixeldungeon.items.stones.StoneOfShock;
import com.alphadraxonis.sandboxpixeldungeon.items.wands.Wand;
import com.alphadraxonis.sandboxpixeldungeon.items.wands.WandOfBlastWave;
import com.alphadraxonis.sandboxpixeldungeon.items.wands.WandOfCorrosion;
import com.alphadraxonis.sandboxpixeldungeon.items.wands.WandOfCorruption;
import com.alphadraxonis.sandboxpixeldungeon.items.wands.WandOfDisintegration;
import com.alphadraxonis.sandboxpixeldungeon.items.wands.WandOfFireblast;
import com.alphadraxonis.sandboxpixeldungeon.items.wands.WandOfFrost;
...
import com.alphadraxonis.sandboxpixeldungeon.items.wands.WandOfPrismaticLight;
import com.alphadraxonis.sandboxpixeldungeon.items.wands.WandOfRegrowth;
import com.alphadraxonis.sandboxpixeldungeon.items.wands.WandOfTransfusion;
