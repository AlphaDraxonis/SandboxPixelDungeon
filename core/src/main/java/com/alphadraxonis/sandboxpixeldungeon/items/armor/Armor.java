...
package com.alphadraxonis.sandboxpixeldungeon.items.armor;
...
import com.alphadraxonis.sandboxpixeldungeon.actors.buffs.Momentum;
...
import com.alphadraxonis.sandboxpixeldungeon.items.armor.curses.AntiEntropy;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.curses.Bulk;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.curses.Corrosion;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.curses.Displacement;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.curses.Metabolism;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.curses.Multiplicity;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.curses.Overgrowth;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.curses.Stench;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.glyphs.Affection;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.glyphs.AntiMagic;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.glyphs.Brimstone;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.glyphs.Camouflage;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.glyphs.Entanglement;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.glyphs.Flow;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.glyphs.Obfuscation;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.glyphs.Potential;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.glyphs.Repulsion;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.glyphs.Stone;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.glyphs.Swiftness;
import com.alphadraxonis.sandboxpixeldungeon.items.armor.glyphs.Thorns;
...
public class Armor extends EquipableItem {
    ...
    @Override
    public String name() {
        return glyph != null && (cursedKnown() || !glyph.curse() || CustomDungeon.isEditing()) ? glyph.name(super.name()) : super.name();
    }
