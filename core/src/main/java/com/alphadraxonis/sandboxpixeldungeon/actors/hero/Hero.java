...
import com.alphadraxonis.sandboxpixeldungeon.actors.buffs.AdrenalineSurge;
import com.alphadraxonis.sandboxpixeldungeon.actors.buffs.Amok;
import com.alphadraxonis.sandboxpixeldungeon.actors.buffs.AnkhInvulnerability;
...
import com.alphadraxonis.sandboxpixeldungeon.actors.buffs.Drowsy;
import com.alphadraxonis.sandboxpixeldungeon.actors.buffs.Foresight;
import com.alphadraxonis.sandboxpixeldungeon.actors.buffs.HoldFast;
...
import com.alphadraxonis.sandboxpixeldungeon.actors.buffs.PhysicalEmpower;
...
import com.alphadraxonis.sandboxpixeldungeon.items.Heap.Type;
...
import com.alphadraxonis.sandboxpixeldungeon.items.artifacts.CapeOfThorns;
...
import com.alphadraxonis.sandboxpixeldungeon.windows.WndHero;
                ...
                if ((foresight || fieldOfView[curr]) && curr != pos) {
                    ...
                    if (Dungeon.level.secret[curr]) {
                        ...
                        if (foresight) {
                            ...
                            chance = 0.4f - (Dungeon.getSimulatedDepth() / 250f);

                            //unintentional door detection scales from 20% at floor 0 to 0% at floor 20
                        } else {
                            chance = 0.2f - (Dungeon.getSimulatedDepth() / 100f);
                        }
